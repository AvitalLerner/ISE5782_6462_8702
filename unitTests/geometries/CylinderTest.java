...
class CylinderTest {
    ...
    void testFindIntersections() {
      Cylinder cylinder1=new Cylinder(1,new Ray(new Point(1, 0, 0), new Vector(0, 1, 0)));
        ...
        assertNull(cylinder1.findIntersections(new Ray(new Point(1, 1, 2), new Vector(1, 1, 0))),"there aren't supposed to be intersections");
        ...
        assertEquals(List.of(new Point(0.4, 0.2, 0.2), new Point(2, 1, 1)), result, "Intersections points incorrect");
        ...
        assertEquals(List.of(new Point(2, 1, 1)), result, "Intersection point calculated wrong");
