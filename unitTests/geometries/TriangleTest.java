...
class TriangleTest {
    ...
    void findIntersections() {
        ...
        assertEquals(List.of(new Point(0,0.5,0.5)),tr.findIntersections(ray),
                "findIntersection to point inside the triangle incorrect");

        // TC02: Against edge
        ray= new Ray(new Point(-1,-1,-1),new Vector(1,2,2));
        assertEquals(List.of(new Point(0,1,-1)),pl.findIntersections(ray), "intersection of point against edge with plane incorrect");
        ...
        assertEquals(List.of(new Point(0,0,0)),pl.findIntersections(ray), "intersection of point in vertex with plane incorrect");
        assertNull(tr.findIntersections(ray),
