...
public class ShadowTests {
    private Intersectable sphere = new Sphere(new Point(0, 0, -200), 60d) //
            ...
            .setMaterial(new Material().set_kD(0.5).set_kS(0.5).setShininess(30));
    private Material trMaterial = new Material().set_kD(0.5).set_kS(0.5).setShininess(30);
    ...
    public void trianglesSphere() {
        ...
        scene.geometries.add( //
                new Triangle(new Point(-150, -150, -115), new Point(150, -150, -135), new Point(75, 75, -150)) //
                        .setMaterial(new Material().set_kS(0.8).setShininess(60)), //
                new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150)) //
                        .setMaterial(new Material().set_kS(0.8).setShininess(60)), //
                new Sphere(new Point(0, 0, -11), 30d) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().set_kS(0.5).set_kS(0.5).setShininess(30)) //
        );
        scene.lights.add( //
