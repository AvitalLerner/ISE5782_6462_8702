...
public class LightsTests {
    ...
    private Material material = new Material().set_kD(0.5).set_kS(0.5).setShininess(300);
    ...
    private Geometry sphere = new Sphere(new Point(0, 0, -50), 50d) //
            ...
            .setMaterial(new Material().set_kD(0.5).set_kS(0.5).setShininess(300));
    ...
    public void sphereSpot() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5)).setKl(0.001).setKl(0.0001));
