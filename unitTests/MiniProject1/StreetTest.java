...
//                        .setEmission(new Color(BLUE)),
    ...
    public void StreetNight(){
        ...
        ImageWriter imageWriter = new ImageWriter("MiniProject1night", 800, 800);
        camera.setImageWriter(imageWriter)
                .setRayTracer(new RayTracerBasic(scene))
                .renderImage()
                .writeToImage();
...
//                        .setEmission(new Color(BLUE)),
        ...
        ImageWriter imageWriter = new ImageWriter("MiniProject1lamp", 800, 800);
        camera.setImageWriter(imageWriter)
                .setRayTracer(new RayTracerBasic(scene))
                .renderImage()
                .writeToImage();
    ...
    @Test
    public void StreetNightandMoonLight(){
        Scene scene = new Scene.SceneBuilder("Test scene") //
                //.setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.7)))
                .setBackground(new Color(20, 20, 20))
                .build();
        ...
        ImageWriter imageWriter = new ImageWriter("MiniProject1nightMoon", 800, 800);
        camera.setImageWriter(imageWriter)
                .setRayTracer(new RayTracerBasic(scene))
                .renderImage()
                .writeToImage();
...
//                        .setEmission(new Color(BLUE)),
    ...
    @Test
    public void buildStreetHouselight(){
        Scene scene = new Scene.SceneBuilder("Test scene") //
                .setAmbientLight(new AmbientLight(new Color(WHITE), new Double3(0.7)))
                .setBackground(new Color(220, 255, 255))
                .build();
...
//                        .setEmission(new Color(BLUE)),
        ...
        ImageWriter imageWriter = new ImageWriter("MiniProject1HouseLight", 800, 800);
        camera.setImageWriter(imageWriter)
                .setRayTracer(new RayTracerBasic(scene))
                .renderImage()
                .writeToImage();
